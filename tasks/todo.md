...
- [ ] Поле `icon` у задач: тип, миграция, IconPicker в шторке, подбор иконки по названию
- [ ] Экран «День»: HeroCard (сейчас / далее / всё сделано), компактный список с иконками, «без времени», удалить часовую сетку и drag
- [ ] Мобильная адаптация: прокрутка страницы, max-w 480 на десктопе, тач-цели ≥44
- [ ] ПРОВЕРКА: Playwright на iPhone-viewport + скриншот против макета; деплой; Максим смотрит на телефоне
