...
- [x] ПРОВЕРКА Максимом на iPhone 04.09 ~21:30: свайп «работает супер» после перехода на touch без сдачи на неотменяемом move; стрелки внизу; расписание синкается
